...
facebook_europawahl %>% 
  ggplot(aes(x = comments_count, y = shares_count, color = party, shape = type)) +
  geom_point() +
  scale_y_continuous(name = "Anzahl der Shares", limits = c(0, 12000), breaks = seq(0, 12000, 2000)) +
  scale_x_continuous(name = "Anzahl der Kommentare", limits = c(0, 12000), breaks = seq (0, 12000, 2000)) +
