...
```
Das sich darunter fast keine Trigramme (außer eine Hashtag-Kominbation bei der FDP) befinden, ziehen wir daraus vorerst keinen Mehrwert. Die Zeichenkette `\U0001f1ea\U0001f1fa` verweist auf Fehler bei der Bereinigung der Texte -- hierbei handelt es sich um den Code für das Europaflaggen-Emoji, der eigentlich durch `remove_symbols = TRUE` hätte entfernt werden sollen. Hier sollte also manuell nachgebessert werden.
